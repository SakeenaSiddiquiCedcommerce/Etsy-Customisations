		...
		public static function get_custom_products_fields( $shop_name = '' ) {
			...
			$required_fields = array(
				...
				'optional'        => array(
					...
					array(
						'type'     => '_text_input',
						'id'       => '_ced_etsy_conversion_rate',
						'fields'   => array(
							'id'          => '_ced_etsy_conversion_rate',
							'label'       => __( 'Currency Conversion Rate', 'woocommerce-etsy-integration' ),
							'desc_tip'    => true,
							'description' => __( 'Enter curreny conversion rate to manage the currency difference' ),
							'type'        => 'text',
							'is_required' => false,
							'class'       => 'wc_input_price',
							'default'     => '',
