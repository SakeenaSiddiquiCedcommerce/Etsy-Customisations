	...
	public function ced_etsy_all_settings_fields() {
		return array(
			...
			'order_imoprt_settings'   => array(
				...
				array(
					'label'   => __( 'Create Etsy orders on WooCommerce', 'etsy-woocommerce-integration' ),
					'tooltip' => 'Enable If you want to create Etsy order on WooCommerce.',
					'type'    => 'check',
					'name'    => 'create_etsy_order_on_woocommerce',
					'options' => '',
				),
